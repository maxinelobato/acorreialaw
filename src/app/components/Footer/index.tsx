    ...
    <footer className='mt-24'>
      <div className='max-w-screen-xl mx-auto px-4 text-white md:px-8'>
        <div className='space-y-6 text-center max-w-screen-xl mx-auto sm:max-w-lg sm:mx-auto sm:text-center'>
          ...
          />
          <p className='text-stone-200'>Advocacia Especializada em Contratos</p>
          <p className='text-stone-200'>Entre em contato conosco</p>
          <div className='items-center gap-x-3 space-y-3 sm:flex sm:justify-center sm:space-y-0'>
            ...
            <p className='flex items-center justify-center gap-x-2 py-2 px-4 text-stone-200 font-medium md:inline-flex'>
              ...
              contato@acorreialaw.com
            </p>
          </div>
        </div>
        <div className='text-stone-200 mt-10 py-10 border-t items-center justify-between sm:flex'>
